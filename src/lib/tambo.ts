...
// Helper to convert Zod schemas to JSON Schema, bypassing SDK's broken converter
const toJSONSchema = (schema: any) => zodToJsonSchema(schema, { target: "jsonSchema7" });
...
export const tools: any[] = [
  {
    ...
    outputSchema: toJSONSchema(z.any()),
...
export const components: TamboComponent[] = [
  {
    ...
    component: RepoCard,
    propsSchema: toJSONSchema(z.object({
  ...
  },
  {
    ...
    component: Graph,
    propsSchema: toJSONSchema(graphSchema),
  },
  {
